...
routes.get('/:id', middleware.authorize([Role.Admin, Role.User]), UserController.getOne);

routes.post('/', middleware.authorize([Role.Admin]), UserController.create);

routes.patch('/:id', middleware.authorize([Role.Admin, Role.User]), UserController.update);
